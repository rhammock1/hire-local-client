...
const LandingPopUp = function(props) {
  ...
  return (
    <div className="popup">
      ...
      <p>
        As a user you can search for jobs by title, zipcode, and radius. All test jobs are labeled 'Test Title' and under the zipcode <strong>80014</strong>. A message 
